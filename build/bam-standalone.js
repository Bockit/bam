...
define("lib/almond-0.2.5", function(){});
      ...
      View.prototype.calcTransition = function(from, to) {
        ...
        if (!transition) {
          transition = _.first(_.filter(this.transitions, function(t) {
            return matchState(from, t.from) && matchState(to, t.to);
          }));
        }
        return transition;
      };
...
(function() {
  ...
  define('cs!src/model',['backbone'], function(Backbone) {
    var Model, _ref;
...
(function() {
  ...
  define('cs!src/collection',['backbone'], function(Backbone) {
    var Collection, _ref;
